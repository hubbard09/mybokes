...
<div class="newblog left">
    ...
    <form id="contact-form" method="post">
        <label>
            <div class="sc">
                <p><?php echo '姓名：&nbsp;'. $onef['name'] ?></p>
                <p><?php echo '内容：&nbsp;'. $onef['content'] ?></p>
                <p><?php echo '发表时间：&nbsp;'. $onef['lastdate'] ?></p>
            </div>
        </label>
        <textarea rows="25px" cols="80px" class="inputr" name="content"/><?php echo $_SESSION['username'] .'&nbsp;&nbsp;'.'回复&nbsp;&nbsp;'.$onef['name'].'&nbsp;&nbsp;：'; ?></textarea>
