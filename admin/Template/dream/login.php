...
<div id="login">
    <h1>
        <a href="index.php" title="由我所领"></a><img class="ss" src="../images/9.jpg" title="由我所领">
    </h1>
    ...
    <form name="loginform" id="loginform" action="login.php" method="post">
        ...
        <p class="submit">
            <input type="submit" name="submit" id="submit" value="登录" tabindex="100">
        </p>
        <p class="submit">
            <input type="submit" name="submit" id="enroll" value="注册" tabindex="100">&nbsp;&nbsp;&nbsp;&nbsp;
        </p>
        <p>其他用户登录：<a href="app.php"><img src="../images/connect/Connect_logo_1.png"></a></p>
    </form>
</div>
